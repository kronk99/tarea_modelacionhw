...
##Descripción general
Riego-TEC un 
sistema interactivo que monitorea automáticamente la humedad del suelo en macetas o jardines pequeños. 
Utiliza un sensor para detectar niveles bajos de humedad y activa una bomba de agua para regar las plantas solo cuando es necesario. 
Esto previene el exceso o déficit de agua, ahorrando recursos y manteniendo las plantas saludables.
